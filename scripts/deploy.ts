...
import { GassedupApp } from '../src/contracts/gassedupApp'
...
async function main() {
    await GassedupApp.loadArtifact()
    ...
    const instance = new GassedupApp(
    ...
    console.log('GassedupApp contract was successfully deployed!')
